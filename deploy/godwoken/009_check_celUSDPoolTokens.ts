...
const USD_TOKENS_ARGS: { [token: string]: any[] } = {
  cDAI: ["DAI (via Celer cBridge from ETH)", "DAI", "18"],
  cUSDC: ["USDC (via Celer cBridge from ETH)", "USDC", "6"],
  cUSDT: ["USDT (via Celer cBridge from ETH)", "USDT", "6"],
}
