 ...
 * As an example, if there is a Swap pool consisting of [DAI, USDC, BUSD], then a MetaSwap pool can be created
...
contract MetaSwap is Swap {
     ...
     * [DAI, USDC, BUSD]. Then a MetaSwap pool can be created with [sUSD, BaseSwapLPToken]
     * as _pooledTokens.
     *
